  ...
  return (
    <div className="group rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-2xl transition duration-300">
      ...
      <div className="relative overflow-hidden">
        ...
        />
        <div className="absolute top-4 left-4 bg-yellow-500 text-black px-3 py-1 text-xs font-medium rounded">
          Featured
        </div>
      ...
      {/* Content */}
      <div className="p-6">
        <h3 className="text-lg font-semibold mb-2">Modern Luxury Villa</h3>
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-400">Beverly Hills, CA</span>
